"""attractor-study — the meta-register (MR) basin research line.

Spun off from ``llmoji-study`` on 2026-05-15. The kaomoji-introspection
work stays in ``llmoji-study``; this repo owns the attractor-trajectory
...
the quadrant taxonomy) is imported from ``llmoji_study.*`` — install
